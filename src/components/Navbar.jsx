        ...
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="group flex items-center">
            <img 
              ...
              alt="eFI Studio" 
              className="h-16 sm:h-24 w-auto object-contain transition-opacity duration-200 group-hover:opacity-90" 
            />
          </a>
          ...
          <div className="hidden sm:flex items-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2 rounded-full text-xs font-semibold uppercase tracking-wider text-efi-dark bg-efi-gold hover:bg-efi-gold-hover hover:shadow-glow-gold hover:scale-[1.02] transition-all duration-200"
            >
              Clarity Session
